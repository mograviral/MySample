<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StackChart.aspx.cs" Inherits="WebSolutionChart.StackChart" %>
          ...
          function BindDegreeWithCast() {
            ...
            //  var degreeName = $("#ddlDegree  option:selected").text();
              ...
              $.ajax({
                  ...
                  url: "StackChart.aspx/Get_DataFor_BindDegreeWithCast",
                  ...
                  success: function (data) {
                      ...
                      if (data.d.length > 0 && data != null) {
                          ...
                          var highchartstring = "$(function () {                          $('#container').highcharts({                              chart: {                                  type: 'column'                              },                              title: {                                  text: 'Stacked column chart of Students by " + reporttype + "'                              },  subtitle: {text: '" + InstituteName + ", " + academicYear + ", " + curdate + "' },                            xAxis: {                                  categories: [" + degrees + "]                              },                              yAxis: {                                  min: 0,                                  title: {                                      text: 'Number Of Students'                                  },                                  stackLabels: {                                      enabled: true,                                      style: {                                          fontWeight: 'bold',                                          color: (Highcharts.theme && Highcharts.theme.textColor) || 'gray'                                      }                                  }                              },                              legend: {                                  align: 'right',                                  x: -20,                                  verticalAlign: 'top',                                  y: 15,                                  floating: true,                                  backgroundColor: (Highcharts.theme && Highcharts.theme.background2) || 'white',                                  borderColor: '#CCC',                                  borderWidth: 1,                                  shadow: false                              },                              tooltip: {                                  headerFormat: '<b>{point.x}</b><br/>',                                  pointFormat: '{series.name}: {point.y}<br/>Total: {point.stackTotal}'                              },                              plotOptions: {                                  column: {                                      stacking: 'normal',                                      dataLabels: {                                          enabled: true,                                          color: (Highcharts.theme && Highcharts.theme.dataLabelsColor) || 'white',                                          style: {                                              textShadow: '0 0 3px black'                                          }                                      }                                  }                              },  ";
                          var highchartstring2 = "series: [" + resdata + "]                          });                      });";

                          var highchartstring3 = highchartstring + highchartstring2;
                          var highchartstring4 = "$(function () {                          $('#container2').highcharts({                              chart: {                                  type: 'column'                              },                              title: {                                  text: 'Stacked column chart of Students by " + reporttype + "'                          },     subtitle: {text: '" + InstituteName + ", " + academicYear + ", " + curdate + "' },                          xAxis: {                                  categories: [" + degrees + "]                              },                              yAxis: {                                  min: 0,                                  title: {                                      text: 'Number Of Students'                                  }  ,               stackLabels: {                enabled: true,                style: {                    fontWeight: 'bold',                    color: (Highcharts.theme && Highcharts.theme.textColor) || 'gray'                }            }                            },                              tooltip: {                                  pointFormat: '<span style=\"color:{series.color}\">{series.name}</span>: <b>{point.y}</b> ({point.percentage:.0f}%)<br/>',                                  shared: true                              },                              plotOptions: {                                  column: {                                      stacking: 'percent'                                  }                              },";
                          ...
                          var highchartstring = "$(function () {                          $('#container').highcharts({                              chart: {                                  type: 'column'                              },                              title: {                                  text: 'Stacked column chart of Students by " + reporttype + "'                              },  subtitle: {text: '" + InstituteName + ", " + academicYear + ", " + curdate + "' },                            xAxis: {                                  categories: []                              },                              yAxis: {                                  min: 0,                                  title: {                                      text: 'Number Of Students'                                  },                                  stackLabels: {                                      enabled: true,                                      style: {                                          fontWeight: 'bold',                                          color: (Highcharts.theme && Highcharts.theme.textColor) || 'gray'                                      }                                  }                              },                              legend: {                                  align: 'right',                                  x: -20,                                  verticalAlign: 'top',                                  y: 15,                                  floating: true,                                  backgroundColor: (Highcharts.theme && Highcharts.theme.background2) || 'white',                                  borderColor: '#CCC',                                  borderWidth: 1,                                  shadow: false                              },                              tooltip: {                                  headerFormat: '<b>{point.x}</b><br/>',                                  pointFormat: '{series.name}: {point.y}<br/>Total: {point.stackTotal}'                              },                              plotOptions: {                                  column: {                                      stacking: 'normal',                                      dataLabels: {                                          enabled: true,                                          color: (Highcharts.theme && Highcharts.theme.dataLabelsColor) || 'white',                                          style: {                                              textShadow: '0 0 3px black'                                          }                                      }                                  }                              },  ";
                          var highchartstring2 = "series: []                          });                      });";

                          var highchartstring3 = highchartstring + highchartstring2;
                          var highchartstring4 = "$(function () {                          $('#container2').highcharts({                              chart: {                                  type: 'column'                              },                              title: {                                  text: 'Stacked column chart of Students by " + reporttype + "'                          },     subtitle: {text: '" + InstituteName + ", " + academicYear + ", " + curdate + "' },                          xAxis: {                                  categories: []                              },                              yAxis: {                                  min: 0,                                  title: {                                      text: 'Number Of Students'                                  }  ,               stackLabels: {                enabled: true,                style: {                    fontWeight: 'bold',                    color: (Highcharts.theme && Highcharts.theme.textColor) || 'gray'                }            }                            },                              tooltip: {                                  pointFormat: '<span style=\"color:{series.color}\">{series.name}</span>: <b>{point.y}</b> ({point.percentage:.0f}%)<br/>',                                  shared: true                              },                              plotOptions: {                                  column: {                                      stacking: 'percent'                                  }                              },";
          ...
          function BindDegreeWithActualCast() {
            ...
            //  var degreeName = $("#ddlDegree  option:selected").text();
              ...
              $.ajax({
                  type: "POST",
                  contentType: "application/json;charset=utf-8",
                  url: "StackChart.aspx/Get_DataFor_BindDegreeWithActualCast",
                  data: "{'InstituteID':'" + instituteID + "','AcademicYear':'" + academicYear + "'}",
                  dataType: "Json",
                  success: function (data) {
                      if (data.d.length > 0 && data != null) {
                          ...
                          var highchartstring3 = highchartstring + highchartstring2;
                          var highchartstring4 = "$(function () {                          $('#container2').highcharts({                              chart: {                                  type: 'column'                              },                              title: {                                  text: 'Stacked column chart of Students by " + reporttype + "'                          },     subtitle: {text: '" + InstituteName + ", " + academicYear + ", " + curdate + "' },                          xAxis: {                                  categories: [" + degrees + "]                              },                              yAxis: {                                  min: 0,                                  title: {                                      text: 'Number Of Students'                                  }                              },                              tooltip: {                                  pointFormat: '<span style=\"color:{series.color}\">{series.name}</span>: <b>{point.y}</b> ({point.percentage:.0f}%)<br/>',                                  shared: true                              },                              plotOptions: {                                  column: {                                      stacking: 'percent'                                  }                              },";
                          var highchartstring5 = "series: [" + resdata + "]                          });                      });";
                          var highchartstring6 = highchartstring4 + highchartstring5;
                          ...
                          var highchartstring3 = highchartstring + highchartstring2;
                          var highchartstring4 = "$(function () {                          $('#container2').highcharts({                              chart: {                                  type: 'column'                              },                              title: {                                  text: 'Stacked column chart of Students by " + reporttype + "'                          },     subtitle: {text: '" + InstituteName + ", " + academicYear + ", " + curdate + "' },                          xAxis: {                                  categories: []                              },                              yAxis: {                                  min: 0,                                  title: {                                      text: 'Number Of Students'                                  }                              },                              tooltip: {                                  pointFormat: '<span style=\"color:{series.color}\">{series.name}</span>: <b>{point.y}</b> ({point.percentage:.0f}%)<br/>',                                  shared: true                              },                              plotOptions: {                                  column: {                                      stacking: 'percent'                                  }                              },";
                          var highchartstring5 = "series: []                          });                      });";
                          var highchartstring6 = highchartstring4 + highchartstring5;
          ...
          function BindDegreeWithAdmissionType() {
           ...
           //   var degreeName = $("#ddlDegree  option:selected").text();
              ...
              $.ajax({
                  type: "POST",
                  contentType: "application/json;charset=utf-8",
                  url: "StackChart.aspx/Get_DataFor_BindDegreeWithAdmissionType",
                  data: "{'InstituteID':'" + instituteID + "','AcademicYear':'" + academicYear + "'}",
                  dataType: "Json",
                  success: function (data) {
                      if (data.d.length > 0 && data != null) {
          ...
          function BindDegreeWithGender() {
            ...
            //  var degreeName = $("#ddlDegree  option:selected").text();
              ...
              $.ajax({
                  type: "POST",
                  contentType: "application/json;charset=utf-8",
                  url: "StackChart.aspx/Get_DataFor_BindDegreeWithGender",
                  data: "{'InstituteID':'" + instituteID + "','AcademicYear':'" + academicYear + "'}",
                  dataType: "Json",
                  success: function (data) {
                      if (data.d.length > 0 && data != null) {
          ...
          function UnivDDLChange() {
              ...
              $("#ddlUniversity").change(function () {
                  ...
                  $.ajax({
                      type: "POST",
                      contentType: "application/json;charset=utf-8",
                      url: "StackChart.aspx/Get_DataFor_BindInstituteInfo",
                      data: "{'UnivID':'" + UnivID + "'}",
                      dataType: "Json",
                      success: function (data) {
                          //alert(data);
...
//                      type: "POST",
//                      contentType: "application/json;charset=utf-8",
//                      url: "StackChart.aspx/Get_DataFor_BindDegreeInfo",
