<%@ Page Title="" Language="C#" MasterPageFile="~/MasterChart.Master" AutoEventWireup="true" CodeBehind="ChartDegreeWise.aspx.cs" Inherits="WebSolutionChart.ChartDegreeWise" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  <title>Degree Wise Chart</title>
     ...
     <script type="text/javascript">
         ...
         function BindDegreeWithCast() {
             ...
             $.ajax({
                 ...
                 url: "ChartDegreeWise.aspx/Get_DataFor_BindDegreeWithCast",
                 ...
                 success: function (data) {
                     ...
                     var piechart = "   $('#container2').highcharts({                chart: {                    plotBackgroundColor: null,                    plotBorderWidth: null,                    plotShadow: false,                    type: 'pie'                },                title: {                    text:'Report Name : " + reporttype + " '               },   subtitle: {                                 text: 'Institute : " + InstituteName + ", Degree : " + degreeName + ", Academic Year : " + academicYear + " , Total Students : " + totalstudents + ",Report Date : " + curdate + "'                             },               tooltip: {                    pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'                },                plotOptions: {                    pie: {                        allowPointSelect: true,                        cursor: 'pointer',                        dataLabels: {                            enabled: true,                            format: '<b>{point.name}</b>: {point.percentage:.1f} %',                            style: {                                color: (Highcharts.theme && Highcharts.theme.contrastTextColor) || 'black'                            },                            connectorColor: 'silver'                        }                    }                },                series: [{                    name: 'Brands',";
         ...
         function BindDegreeWithActualCast() {
             ...
             $.ajax({
                 type: "POST",
                 contentType: "application/json;charset=utf-8",
                 url: "ChartDegreeWise.aspx/Get_DataFor_BindDegreeWithActualCast",
                 data: "{'DegreeID':'" + degreeID + "','InstituteID':'" + instituteID + "','AcademicYear':'" + academicYear + "'}",
                 dataType: "Json",
                 success: function (data) {
                     var resdata = "";
         ...
         function BindDegreeWithAdmissionType() {
             ...
             $.ajax({
                 type: "POST",
                 contentType: "application/json;charset=utf-8",
                 url: "ChartDegreeWise.aspx/Get_DataFor_BindDegreeWithAdmissionType",
                 data: "{'DegreeID':'" + degreeID + "','InstituteID':'" + instituteID + "','AcademicYear':'" + academicYear + "'}",
                 dataType: "Json",
                 success: function (data) {
                     var resdata = "";
         ...
         function BindDegreeWithGender() {
             ...
             $.ajax({
                 type: "POST",
                 contentType: "application/json;charset=utf-8",
                 url: "ChartDegreeWise.aspx/Get_DataFor_BindDegreeWithGender",
                 data: "{'DegreeID':'" + degreeID + "','InstituteID':'" + instituteID + "','AcademicYear':'" + academicYear + "'}",
                 dataType: "Json",
                 success: function (data) {
                     var resdata = "";
         ...
         function UnivDDLChange() {
             ...
             $("#ddlUniversity").change(function () {
                 ...
                 $.ajax({
                     type: "POST",
                     contentType: "application/json;charset=utf-8",
                     url: "ChartDegreeWise.aspx/Get_DataFor_BindInstituteInfo",
                     data: "{'UnivID':'" + UnivID + "'}",
                     dataType: "Json",
                     success: function (data) {
                         //alert(data);
         ...
         function InstituteDDLChange() {
             $("#ddlInstitute").change(function () {
                 ...
                 $.ajax({
                     type: "POST",
                     contentType: "application/json;charset=utf-8",
                     url: "ChartDegreeWise.aspx/Get_DataFor_BindDegreeInfo",
  ...
  <div>
        ...
        <div>
            ...
            <asp:Label ID="lblAcademicYear" runat="server" Text="Academic Year" ForeColor="White"
                CssClass="lblstyle lblstyle2 lblstyle3"></asp:Label>
                    <asp:Label ID="lblUniversity" runat="server" Text="University" ForeColor="White"
                CssClass="lblstyle lblstyle3"></asp:Label>
            <asp:Label ID="lblInstitute" runat="server" Text="Institute" ForeColor="White" CssClass="lblstyle lblstyle3 lblstyle4"></asp:Label>
            <asp:Label ID="lblDegree" runat="server" Text="Degree" ForeColor="White" CssClass="lblstyle lblstyle3 lblstyle4"></asp:Label>
