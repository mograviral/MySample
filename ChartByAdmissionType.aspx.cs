...
{
    public partial class ChartByAdmissionType : System.Web.UI.Page
    {
        ...
        public static List<string> Get_DataFor_BindDegreeWithCast(string DegreeID, string InstituteID, string AcademicYear)
        {
            try
            {
                List<string> lst = new List<string>();
                StudentCountInfo objStudentCount = new StudentCountInfo();
                DataTable dtDegreeWithCast = objStudentCount.getStudentInfo(9, 0, AcademicYear, 0, "", 0, Convert.ToInt32(InstituteID), Convert.ToInt32(DegreeID), "");
